...
The `baseurl` (e.g. `/f5-w-0102030405ab2f2f.../`) is extracted from Webtop HTML at login time; it encodes the upstream hostname in hex for the F5 BIG-IP reverse proxy. Falls back to `_defaultBaseurl` constant if extraction fails.
