...
The `baseurl` (e.g. `/f5-w-0102030405ab2f2f.../`) is extracted from Webtop HTML at login time; it embeds the hex-encoded upstream hostname used by the F5 BIG-IP reverse proxy.
